...
//   constructor(model: PrismaClient<PrismaClientOptions>) {
//     // this.table = Prisma.getExtensionContext();
//   }

//   static async list(request: Request, response: Response) {
//     const { id } = request.query;
//     let data;
//     let table: any = "status";

//     if (id) {
//         data = await client[table].findFirst({
//             where: {
//                 id: Number(id)
//             },
//             orderBy: {
...
//         });
//     } else {
//         data = await client[table].findMany({
//             orderBy: {
//                 id: "asc"
//             }
//         });
